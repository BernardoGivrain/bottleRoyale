...
export default function AirlineSearch({ airline = '', setAirline = () => {} }){
  const airlines = [
    'Air France',
    'British Airways',
    'Cathay Pacific',
    ...
    <div style={{width: '100%', maxWidth: 520}}>
      ...
      <div className="mt-2 bg-white/90 rounded-md p-2 shadow-sm">
        {results.length ? results.map(r => (
          <div key={r} className="py-1 px-2 hover:bg-gray-100 rounded cursor-pointer" onMouseDown={() => setQuery(r)}>{r}</div>
